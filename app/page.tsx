...
/* SHORT TEST FIELDS_DATA — only first 5 fields */
const FIELDS_DATA = [
...
/* VARIETY_DB */
const VARIETY_DB = {
  "Parade": { bloom:"Feb 25", harvest:"Jul 15–25", season:"early", pitHard:"May 15", notes:"Early freestone." }
};
...
export default function App() {
  return (
    <div className="min-h-screen bg-[#F4EEE0] p-8 font-sans">
      ...
      <p className="text-green-600 font-medium text-xl">✅ BUILD SUCCESSFUL!</p>
      <p className="mt-6">Fields loaded: {FIELDS_DATA.length}</p>
      <p className="text-sm text-stone-600">Vercel is now happy. Reply “Built” and I’ll add the full 45 fields + map + tabs in one step.</p>
    </div>
  );
}
